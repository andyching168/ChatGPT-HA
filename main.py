...
data = {
    ...
    '原神樹脂量': 'sensor.yuan_shen_shu_zhi_liang',
    '原神洞天寶錢數': 'sensor.yuan_shen_dong_tian_bao_qian_shu',
    '原神週本減半次數': 'sensor.yuan_shen_zhou_ben_jian_ban_ci_shu',
    '原神探索派遣完成數': 'sensor.yuan_shen_tan_suo_pai_qian_wan_cheng_shu',
    '原神每日委託完成個數': 'sensor.yuan_shen_mei_ri_wei_tuo_wan_cheng_ge_shu'
}
